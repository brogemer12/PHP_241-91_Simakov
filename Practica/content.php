...
?>
            <table>
                ...
                <tr>
                    <th><?php echo $i++; ?></th>
                    <th><?php echo htmlspecialchars($row['First name']); ?></th>
                    <th><?php echo htmlspecialchars($row['Name']); ?></th>
                    <th><?php echo htmlspecialchars($row['Last name']); ?></th>
                    <th><?php echo htmlspecialchars($row['Phone']); ?></th>
                    <th><?php echo htmlspecialchars($row['email']); ?></th>
                    <th><?php echo htmlspecialchars($row['Adres']); ?></th>
